...
> ⚠️ **Note:** This package **ONLY works in a Dockerized environment**. See project https://github.com/erebos12/idemax. From there you can copy the entire folder `bdd-test` into your project!
